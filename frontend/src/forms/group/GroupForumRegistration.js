...
const GroupForumRegistration = () => {
  ...
  const fetchForms = async () => {
    const response = await axios.get(
      `/api/forms/grp-forum-registraion/${user.jsgGroupName}`
    );
  ...
  const newForm = () => {
    navigate("/form/grp-forum-registraion");
  };
                    ...
                    <Row>
                      <Col>
                        <div style={{ textAlign: "center" }}>
                          <LinkContainer
                            to={`/grp-forum-registraion-response/${form.id}`}
                          >
                        ...
                        if (form.user === user.user_id) {
                          return (
                            <Col>
                              <div style={{ textAlign: "center" }}>
                                <LinkContainer
                                  to={`/form/grp-forum-registraion/${form.id}/edit`}
                                >
                                  <Button variant="light" className="btn--four">
                                    Edit Form
                                  </Button>
