...
const GroupEGM = () => {
  ...
  const fetchForms = async () => {
    const response = await axios.get(`/api/forms/grp-egm/${user.jsgGroupName}`);
                    ...
                    <Row>
                      <Col>
                        <div style={{ textAlign: "center" }}>
                          <LinkContainer to={`/grpegm-response/${form.id}`}>
