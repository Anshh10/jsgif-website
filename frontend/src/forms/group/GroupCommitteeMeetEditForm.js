...
const GroupCommitteeMeetEditForm = () => {
  ...
  const [grpJtSecretary, setGrpJtSecretary] = useState("");
  ...
  const EditForm = () => {
    axios
      .get(`/api/forms/group/grp-committee-meet/${responseId.id}/`)
      .then(function (res) {
        ...
        setGrpJtSecretary(res.data.grpJtSecretary);
  ...
  const redirectToResponse = (id) => {
    navigate(`/grpcommitteemeet-response/${id}`, { replace: true });
  };
  ...
  async function FormSubmit(event) {
    ...
    formField.append("grpJtSecretary", grpJtSecretary);
    formField.append("agendaPoint", agendaPoint);

    await axios({
      method: "put",
      url: `/api/forms/group/grp-committee-meet/${response.id}/`,
      data: formField,
    })
        ...
        <Form onSubmit={FormSubmit}>
          ...
          <Row className="mb-3">
            ...
            <Form.Group as={Col} controlId="forTheYear">
              <Form.Label>Group Jt. Secretary</Form.Label>
              <Form.Control
                placeholder="Name of the Jt. Secretary"
                name="grpJtSecretary"
                value={grpJtSecretary}
                onChange={(e) => setGrpJtSecretary(e.target.value)}
              />
            </Form.Group>
          </Row>
...
export default GroupCommitteeMeetEditForm;
