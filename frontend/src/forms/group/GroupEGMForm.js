...
const GroupEGMForm = () => {
  ...
  const [electionSTime, setElectionSTime] = useState("00:00");
  const [electionWDay, setElectionWDay] = useState("");
  const [electionWDate, setElectionWDate] = useState("");
  const [electionWTime, setElectionWTime] = useState("00:00");
