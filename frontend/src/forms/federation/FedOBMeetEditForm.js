...
const FedOBMeetEditResponse = () => {
  ...
  const redirectToResponse = (id) => {
    navigate(`/fed-obmeet-response/${id}`, { replace: true });
  };
  ...
  async function FormSubmit(event) {
    ...
    await axios({
      method: "put",
      url: `http://127.0.0.1:8000/api/forms/federation/fed-obmeet/${response.id}/`,
      data: formField,
    })
...
export default FedOBMeetEditResponse;
